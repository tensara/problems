...
class avg_pool_1d(Problem):
    ...
    def generate_test_cases(self, dtype: torch.dtype) -> List[Dict[str, Any]]:
        ...
        test_configs = [
            ...
            (32768, 3, 1, 1),  # H=1024, k=3, S=1, P=1
            (65536, 5, 3, 2),  # H=2048, k=5, S=3, P=2
            (131072, 7, 4, 3),  # H=131072, k=7, S=4, P=3
            (262144, 2, 1, 0),  # H=262144, k=2, S=1, P=0
            (524288, 3, 2, 1),  # H=524288, k=3, S=2, P=1
        ]
