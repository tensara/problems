...
class mxfp8_gemm(Problem):
    ...
    def __init__(self):
        super().__init__(name="mxfp8-gemm")
    ...
    def _make_case(self, m: int, n: int, k: int, name: str) -> Dict[str, Any]:
        ...
        def create_inputs(m=m, n=n, k=k, seed=seed):
            ...
            scale_a_e8m0, a_lp = to_mx(a, torch.float8_e4m3fn, BLOCK_SIZE, is_swizzled_scales=True)
            scale_b_e8m0, b_lp = to_mx(b, torch.float8_e4m3fn, BLOCK_SIZE, is_swizzled_scales=True)
