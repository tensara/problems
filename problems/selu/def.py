...
class selu(Problem):
    ...
    def generate_sample(self, dtype: torch.dtype = torch.float32) -> List[Dict[str, Any]]:
        ...
        return {
            ...
            "create_inputs": lambda m=m, n=n: (
                # Create input with both positive and negative values for testing SELU
    ...
    def verify_result(self, expected_output: torch.Tensor, 
        ...
        """
        Verify if the SELU result is correct.
        ...
        """
        is_close = torch.allclose(actual_output, expected_output, rtol=1e-4, atol=8e-5)
        ...
        if not is_close:
            ...
            # Check for differences in activation pattern (positive vs negative)
            expected_positive = (expected_output > 0).sum().item()
            actual_positive = (actual_output > 0).sum().item()
            
            debug_info = {
                "max_difference": max_diff,
                "mean_difference": mean_diff,
                "sample_differences": sample_diffs,
                "message": f'Expected {expected_positive} positive values, got {actual_positive} positive values'
            }
    ...
    def get_function_signature(self) -> Dict[str, Any]:
        """
        Get the function signature for the SELU solution.
    ...
    def get_flops(self, test_case: Dict[str, Any]) -> int:
        ...
        # M*N FLOPs:
        # - Each element requires multiple operations (comparison, multiplication, and exponential)
